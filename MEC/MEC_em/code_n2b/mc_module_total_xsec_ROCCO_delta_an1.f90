module mc_module
   implicit none
   integer*4, private, save :: nev,xA,xZ,i_fg,i_fsi,np,ne,nwlk,npot,np_del,total_isospin
   integer*4, private, parameter :: neq=10000,nvoid=10,np0=40
...
subroutine mc_init(i_fg_in,pwia,i_fsi_in,irn_in,nev_in,nwlk_in,xpf_in,thetalept_in,xmpi_in,xmd_in,xmn_in,xA_in,xZ_in, &
     &   total_isospin_in,nk_fname_in)
  use mathtool
   implicit none
   integer*8 :: irn_in(nwlk_in)
   integer*4 :: nev_in,nwlk_in,xA_in,xZ_in,i_fg_in,np_in,i,j,ne_in,ne0,ien,total_isospin_in
