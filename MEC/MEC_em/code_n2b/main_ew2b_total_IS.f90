program em_2body
   ...
   integer*4 :: nw,nev,i,xA,xZ,total_isospin,i_fg,nq,nenu,iq,ie,i_fsi
...
!   call bcast(cos)   
  ...
  ! call bcast(ne)
   ...
   call mc_init(i_fg,pwia,i_fsi,irn,nev,nwlk,xpf,thetalept,xmpi,xmd,xmn,xA,xZ,total_isospin,nk_fname)
